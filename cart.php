...
<div class="py-3 bg-primary">
    <div class="container">
        <h6 class="text-white">
            ...
            <a href = "cart.php" class="text-white link-underline-primary">
                Cart 
            </a>
        </h6>
    </div>
                                    ...
                                    <?php  
                                        foreach ($items as $citem) 
                                        {
                                            ...
                                            <div class="card product_data shadow-sm mb-3">
                                                <div class="row align-items-center">
                                                    <div class="col-md-2">
                                                        <img src="uploads/<?= $citem['image_thumbnail'] ?>" alt="Image_Thumbnail" width="80px" class="ms-5">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <h5><?= $citem['name'] ?></h5>
                                                    </div>
